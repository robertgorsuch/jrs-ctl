...
| Path | What |
|---|---|
| `image/<platform>/` | the unpacked image: `bin/jrsctl.cmd`, `bin/jrsctl.ps1`, `bin/jrsctl`, `lib/jrsctl.jar`, `runtime/` (jlink), `README.txt`, `LICENSE`, `LICENSE-THIRD-PARTY.txt`, `MANIFEST.sha256` |
